		...
		<script type="text/javascript">
			$(function () {
				...
				$('.sub').on('click',function(){
					...
					window.location.href="${pageContext.request.contextPath}/result/toCloseExceptionRecord.do?replyMsg="+replyMsg+"&recordNo="+recordNo;
				});
				$('.subPass').on('click',function(){
					...
					window.location.href="${pageContext.request.contextPath}/result/toPassExceptionRecord.do?remark="+remark+"&reason="+reason+"&type="+type+"&goods="+goods+"&recordNo="+recordNo;
				});
